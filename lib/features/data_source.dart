...
final List<Person> persons = [
  Person(
    name: "Mahmoud saeed",
    message: """
حابب أشكرك يا م محمد عماد من قلبي على تعبك معانا طول فترة التدريب، وعلى إخلاصك واحترامك اللي لمسناه كلنا، إنت كنت دايمًا حريص تشرح وتوضح لحد ما كل تفصيلة توصل لينا، وما نسيتش في أي وقت إنك تذكرنا بربنا بلطف وإخلاص.
حضرتك بجد قدوة في العلم والانضباط وحُسن الخُلق، والايه الكريمة "سِيمَاهُم فِي وُجُوهِهِم" باينة علي حضرتك  من أول لحظة شوفناك فيها كان لينا الشرف أننا نقابل حضرتك
ربنا يباركلك ويوفقك دايمًا 🌹
""",
